          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start text-left">
              ...
              <p className="text-[#2F3E2F] text-base leading-relaxed mb-6 font-sans">
                Chandhan Nilayam Investments manages 100 acres of premium, high-fertility land near Dornala, Andhra Pradesh. We recognized the rare alignment between the soaring global demand for high-grade sandalwood (*Santalum album*) and the security of physical land ownership.
              </p>
              <p className="text-[#2F3E2F] text-base leading-relaxed mb-6 font-sans">
