...
const testimonials = [
  {
    ...
    text: "I was highly skeptical about managed farm models, but Chandan Nilayam's compliance and clear title deed sold me. The investor portal provides regular, verified crop photos and agronomy reports. Highly recommended for long term diversification.",
    rating: 5,
  ...
  },
  {
    ...
    text: "After retiring, I wanted a secure asset that I could hand down to my children. Chandan Nilayam made the registration deed process transparent. Every step was managed through their legal department with prompt communications.",
    rating: 5,
  ...
  },
  {
    ...
    text: "Chandan Nilayam has delivered 100% on what was promised. Clear boundary sketches, prompt payment receipts, and excellent support response rates. A premium agricultural investment platform.",
    rating: 5,
